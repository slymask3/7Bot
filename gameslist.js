...
function fullAvg() {
    ...
    for(i=0; i<userList.items.length; i++) {
        ...
        dmga += parseInt(userList.items[i]['_values']['sort-damage'].replace(',', ''));
        golda += parseInt(userList.items[i]['_values']['sort-gold'].replace(',', ''));
        csa += parseInt(userList.items[i]['_values']['sort-cs'].replace(',', ''));
    ...
    document.getElementById("avg-damage").innerHTML = dmga.toFixed(2).toLocaleString("es-MX",{style:"currency", currency:"MXN"});
    document.getElementById("avg-gold").innerHTML = golda.toFixed(2).toLocaleString("es-MX",{style:"currency", currency:"MXN"});
    document.getElementById("avg-cs").innerHTML = csa.toFixed(2).toLocaleString("es-MX",{style:"currency", currency:"MXN"});
...
userList.on("updated", function(){
    ...
    for(i=0; i<userList.matchingItems.length; i++) {
        ...
        dmgaf += parseInt(userList.matchingItems[i]['_values']['sort-damage'].replace(',', ''));
        goldaf += parseInt(userList.matchingItems[i]['_values']['sort-gold'].replace(',', ''));
        csaf += parseInt(userList.matchingItems[i]['_values']['sort-cs'].replace(',', ''));
    ...
    document.getElementById("avg-damage-f").innerHTML = dmgaf.toFixed(2).toLocaleString("es-MX",{style:"currency", currency:"MXN"});
    document.getElementById("avg-gold-f").innerHTML = goldaf.toFixed(2).toLocaleString("es-MX",{style:"currency", currency:"MXN"});
    document.getElementById("avg-cs-f").innerHTML = csaf.toFixed(2).toLocaleString("es-MX",{style:"currency", currency:"MXN"});
